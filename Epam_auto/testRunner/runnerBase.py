...
def appium_testcase(l_devices):
    ...
    if l_devices["apkpath"]:
        apk_base = apkBase.apkInfo(PATH(l_devices["apkpath"]))
    ...
    #desired_caps['udid'] = l_devices["deviceName"]
        desired_caps['app'] = PATH(l_devices["apkpath"])
...
def selenium_testcase(get_devices):
    ...
    common.DRIVER = driver
    common.FLAG = False
    driver.maximize_window()  #max browser screen
...
class TestInterfaceCase(unittest.TestCase):
    ...
    def setUpClass():
        ...
        # if common.SELENIUM_APPIUM == common.APPIUM: # appium enter
        #     if ga.platformName == common.ANDROID and common.FLAG:
        #         appium_testcase(ga)
        # if common.SELENIUM_APPIUM == common.SELENIUM and common.FLAG: # selenium enter
